 ...
 *
 * DDD: Infrastructure adapter implementing Dataset repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { DatasetRepository } from "@scorvia/services/projects";
...
/**
 * DatasetRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: DATASET
...
export class DatasetRepositoryDdb implements DatasetRepository {
  ...
  private readonly ENTITY_TYPE = "DATASET";
  private readonly ENTITY_TOKEN = "DATASET";
  private readonly SK_PREFIX = "DATASET";
  ...
  private readonly ENTITY_TYPE_PK = "DATASETS";
