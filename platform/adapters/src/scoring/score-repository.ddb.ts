...
import type { ScoreRepository } from "@scorvia/services/scoring";
...
export class ScoreRepositoryDdb implements ScoreRepository {
  ...
  async scoreApplication(input: Parameters<ScoreRepository['scoreApplication']>[0]): Promise<Awaited<ReturnType<ScoreRepository['scoreApplication']>>> {
