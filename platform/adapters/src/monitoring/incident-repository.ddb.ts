 ...
 *
 * DDD: Infrastructure adapter implementing Incident repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { IncidentRepository } from "@scorvia/services/monitoring";
...
/**
 * IncidentRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: MONITORING_INCIDENT
 * Entity Token: MONITORING_INCIDENT
 * SK Prefix: MONITORING_INCIDENT
 */
export class IncidentRepositoryDdb implements IncidentRepository {
  ...
  private readonly ENTITY_TYPE = "MONITORING_INCIDENT";
  private readonly ENTITY_TOKEN = "MONITORING_INCIDENT";
  private readonly SK_PREFIX = "MONITORING_INCIDENT";
  ...
  private readonly ENTITY_TYPE_PK = "MONITORING_INCIDENTS";
