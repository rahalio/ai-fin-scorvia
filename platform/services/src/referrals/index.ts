/**
 * Referrals Services - Application Layer Export
 *
...
/**
 * Referrals Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for referrals domain.
 */
