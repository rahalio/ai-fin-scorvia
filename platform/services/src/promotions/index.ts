/**
 * Promotions Services - Application Layer Export
 *
...
/**
 * Promotions Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for promotions domain.
 */
